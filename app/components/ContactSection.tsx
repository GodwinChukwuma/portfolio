				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<p className="text-green-600 dark:text-green-500 mt-8 mb-2">Contact</p>
							<motion.a
								href="mailto:godwinchuks032@gmail.com"
								whileHover={{ scale: 1.02 }}
								aria-label="Email Godwin Chukwuma"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/GodwinCyber"
									target="_blank"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-600 dark:text-gray-400">@devgodwin</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/godwin-chukwuma/"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-100 dark:bg-gray-800/50 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-colors border border-gray-200 dark:border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-600 dark:text-gray-400">Godwin Chukwuma</p>
									</div>
								</motion.a>
								<motion.a
									href="https://x.com/code_godwin"
									target="_blank"
									rel="noopener noreferrer"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-100 dark:bg-gray-800/50 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700/50 transition-colors border border-gray-200 dark:border-gray-700/50 group"
								>
									...
									<div>
										...
										<p className="text-sm text-gray-600 dark:text-gray-400">@code_godwin</p>
									</div>
								</motion.a>
							</div>
						</div>
